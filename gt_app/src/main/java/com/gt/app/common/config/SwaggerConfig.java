...
public class SwaggerConfig {
    // 扫描包
    private static final String BASEPACKAGE = "com.gt.app.core.controller";
    // 标题
    private static final String TITLE = "App API";
    // 描述
    private static final String DESC = "多粉APP-API";
    // 版本
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).tags(new Tag("App", "多粉APP-API"), getTags()).select()
                .apis(RequestHandlerSelectors.basePackage(BASEPACKAGE)).paths(PathSelectors.any()).build();
    }

    private Tag[] getTags() {
        Tag[] tags = {new Tag("App", "多粉APP相关接口")};
        return tags;
    }
